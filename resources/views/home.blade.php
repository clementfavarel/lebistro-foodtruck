<x-app-layout>
    ...
    @auth
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 relative z-10">
            @if (Auth::user()->can('administer'))
                <div class="bg-white dark:bg-slate-50 rounded-xl shadow-lg p-8">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white dark:bg-slate-50 rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <p class="text-gray-600 mb-6">Visit us at our regular spot in Linz</p>
        ...
        <!-- News Section -->
        <div class="mt-12">
            <h2 class="text-3xl font-bold mb-8 dark:text-white">Latest News</h2>
            <div class="bg-white dark:bg-slate-50 rounded-xl shadow-lg overflow-hidden">
                <div class="md:flex">
                    <div class="md:w-1/2">
