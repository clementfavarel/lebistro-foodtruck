<footer class="bg-white dark:bg-[#222222] text-dark dark:text-white/80 pt-8 sm:pb-8 mb-20 sm:mb-0 shadow-t-lg">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-wrap justify-between items-start">
            <div class="w-full md:w-1/4 mb-6 md:mb-0">
                <x-application-logo class="block h-24 w-auto fill-current text-black/80 dark:text-white/80 mb-4" />
                <p class="mb-2">&copy; {{ date('Y') }} - {{ config('app.name', 'Le Bistro Foodtruck') }}</p>
                <p>Website created by plkode</p>
            </div>
