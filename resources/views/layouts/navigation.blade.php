<nav x-data="{ open: false }" class="w-full bg-white dark:bg-[#222222] shadow-b-lg z-10">
        ...
        <div class="flex items-center justify-between h-16 sm:h-20">
            ...
            @guest
                <div class="hidden lg:flex items-center gap-2">
                    ...
                    class="bg-orange-500 hover:bg-orange-600 transition-colors">
                    {{ __('Login') }}
                </x-primary-link>
                </div>
            @endguest
    ...
    <div class="block lg:hidden fixed bottom-0 left-0 w-full h-20 bg-white dark:bg-[#222222] z-10">
        <div class="h-full px-4 py-2 flex items-center justify-around">
            ...
            <x-responsive-tab-link :href="route('services')" :active="request()->routeIs('services')">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            @auth
                <x-responsive-tab-link :href="route('fidelity')" :active="request()->routeIs('fidelity')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-gift h-8">
