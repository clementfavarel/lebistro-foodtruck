            ...
            <div class="p-8">
                <form action="{{ route('service.contact.submit') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Event Start Date -->
                        <div>
                            <label for="start_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Event Start Date</label>
                        ...
                        <!-- Event End Date -->
                        <div>
                            <label for="end_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Event End Date</label>
                        ...
                        <div>
                            <label for="duration" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Approximate Duration (hours)</label>
                        ...
                        <!-- Number of People -->
                        <div>
                            <label for="people_count" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Number of People</label>
                    ...
                    <div class="mt-6">
                        <span class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Additional Services</span>
                        <div class="space-y-4">
                            <div>
                                <label for="drinks" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Drinks</label>
                            ...
                            <div>
                                <label for="food" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Food</label>
                            ...
                            <div>
                                <label for="catering_infrastructure" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Catering Infrastructure</label>
